...
The argument I will be forwarding today is that liberalism get things backwards.  It's _skew if_, to borrow another Australian turn of phrase.
...
So rather than attempt to monkey patch political liberalism onto a pluralist polity with fixed boundaries, I'm going to argue we should instead use the idea of an overlapping consensus to define the very boundaries of our political associations themselves.  By reconceptualising _who_ is included within a polity as an endogenous variable of liberal analysis, we can solve the problem of stability over time without the troubles faced by contemporary public reason theory.
...
Since its publication, a number of criticisms have been levelled at _Political Liberalism_. Jonothan Quong [^quong2009:5] provides a goods summary of seven distinct types of critique so it's not my intention to address them here in any detail.  Instead I want to focus on particular problem that I feel is likely to remain even once other criticisms have been addressed: something I call brittleness.
