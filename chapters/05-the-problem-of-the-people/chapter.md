...
> When any number of men have so consented to make one community or government, they are thereby presently incorporated, and make one body politic, wherein the majority have a right to act and conclude the rest. [@locke1988 §95]

> At once, in place of the individual personality of each contracting party, this act of association creates a moral and collective body, composed of as many members as the assembly contains votes, and receiving from this act its unity, its common identity, its life and its will. [@rousseau1920 ch6]
...
If the people asking the question are not the same people in the answer however, then we have a different but equally intractable problem.  Before we can decide who the people should be democratically, we need to first decide which people will do the deciding.  And in order to decide _that_ matter democratically, we need to identify a prior people to decide who gets to decide who gets to decide _ad infinitum_.  When our answer and questioners are the same people, we become trapped in a loop of circular logic.  When they are different people we stumble into an infinite regress.  The question of inclusion cannot be decided democratically.
    ...
    **History**
    ...
    > "Democracy can be practiced for making collective decisions once the collectivity has been defined, but democratic methods themselves are inadequate to establish the bounds of the collectivity, whose existence democratic theory simple pre-supposes." [@whelan1983 
    p22]
...
**Nationality**
    ...
    -- >Yet physical features are a matter of perspective. Rivers divide as as often as they unite communities.  Mountain ranges are borders only to those who live on the plains [@whelan1983 p37]  Economic patterns develop in response to political boundaries, just as much as they form common bonds. p35


    --> These reasons seem to clash with democratic values such s voluntarism, freedom and rationality. [@whelan1983 p31]
...
If the epistemic competence (or what ever content-independent criterion underpins the instrumental account of democracy) is tightly clustered, then how the demos is constituted becomes crucially important. Elsewhere [^under-review] [@kinkead2015] I have demonstrated that clustering of the epistemic competence amongst agents in any political space undermines instrumental justifications of democracy when alternative partitions of the space are possible.  
...
Given the same demos, the requirements of only one instrumental account of democracy can be met. Democracy can be justified on epistemic _or_ preference realisation grounds but not both.  Yet pluralistic instrumental justification of democracy are common in the literature.  Mill justified democracy because it forced representatives to consider the wants of all citizens (content-relative), because it was the most reliable way of reaching the right decision (content-independent), and because it transformed the moral character of citizens (content-indifferent).  Rousseau offered similar pluralist reasons - democracy realises the general will (content-relative) and tells voters when they are correct (content-independent).  When instrumental justifications of democracy require different, incompatible accounts of inclusion, they themselves become incompatible.  And when they are used together, fail to meet the entailment requirement of political justification.
